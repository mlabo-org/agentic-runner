...
- During source upgrade work, direct execution of the source CLI runs source-tree behavior: `node /Users/suzukimakoto/plugins/agentic-runner/bin/agentic-runner.mjs ...`. This validates source behavior, not installed plugin activation.
...
5. Run intake with explicit isolation keys, optional route-state metadata, and optional semantic work metadata:
   `node /Users/suzukimakoto/plugins/agentic-runner/bin/agentic-runner.mjs intake --target-cwd JOBSITE --route-class ROUTE_CLASS --primary-workflow PRIMARY_WORKFLOW [--controlled-workflows WORKFLOW_IDS] --work-type WORK_TYPE --task TASK --task-id TASK_ID --epoch EPOCH --scope SCOPE`.
6. Run doctor:
...
7. Print handoff when needed:
   `node /Users/suzukimakoto/plugins/agentic-runner/bin/agentic-runner.mjs handoff --target-cwd JOBSITE --task-id TASK_ID`.
