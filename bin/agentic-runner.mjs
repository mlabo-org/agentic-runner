...
State:
  ...
  Legacy runner scopes remain available only for simple path-only values such as "README.md", "allowed/", "bin/agentic-runner.mjs tests/workflow-state.test.mjs", ".", "repo", and "whole repo".
